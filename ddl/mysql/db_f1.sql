...
CREATE DATABASE `db_f1` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `db_f1`;

-- Access denied for user &#039;aluno&#039;@&#039;%&#039; to database &#039;db_f1&#039;
...
(1,	'Albert Park Grand Prix Circuit',	'Melbourne',	'Australia',	-37.849700,	144.968000,	10),
(2,	'Sepang International Circuit',	'Kuala Lumpur',	'Malaysia',	2.760830,	101.738000,	18),
(3,	'Bahrain International Circuit',	'Sakhir',	'Bahrain',	26.032500,	50.510600,	7),
(4,	'Circuit de Barcelona-Catalunya',	'Montmeló',	'Spain',	41.570000,	2.261110,	109),
(5,	'Istanbul Park',	'Istanbul',	'Turkey',	40.951700,	29.405000,	130),
(6,	'Circuit de Monaco',	'Monte-Carlo',	'Monaco',	43.734700,	7.420560,	7),
(7,	'Circuit Gilles Villeneuve',	'Montreal',	'Canada',	45.500000,	-73.522800,	13),
(8,	'Circuit de Nevers Magny-Cours',	'Magny Cours',	'France',	46.864200,	3.163610,	228),
(9,	'Silverstone Circuit',	'Silverstone',	'UK',	52.078600,	-1.016940,	153),
(10,	'Hockenheimring',	'Hockenheim',	'Germany',	49.327800,	8.565830,	103),
(11,	'Hungaroring',	'Budapest',	'Hungary',	47.578900,	19.248600,	264),
(12,	'Valencia Street Circuit',	'Valencia',	'Spain',	39.458900,	-0.331667,	4),
(13,	'Circuit de Spa-Francorchamps',	'Spa',	'Belgium',	50.437200,	5.971390,	401),
(14,	'Autodromo Nazionale di Monza',	'Monza',	'Italy',	45.615600,	9.281110,	162),
(15,	'Marina Bay Street Circuit',	'Marina Bay',	'Singapore',	1.291400,	103.864000,	18),
(16,	'Fuji Speedway',	'Oyama',	'Japan',	35.371700,	138.927000,	583),
(17,	'Shanghai International Circuit',	'Shanghai',	'China',	31.338900,	121.220000,	5),
(18,	'Autódromo José Carlos Pace',	'São Paulo',	'Brazil',	-23.703600,	-46.699700,	785),
(19,	'Indianapolis Motor Speedway',	'Indianapolis',	'USA',	39.795000,	-86.234700,	223),
(20,	'Nürburgring',	'Nürburg',	'Germany',	50.335600,	6.947500,	578),
(21,	'Autodromo Enzo e Dino Ferrari',	'Imola',	'Italy',	44.343900,	11.716700,	37),
(22,	'Suzuka Circuit',	'Suzuka',	'Japan',	34.843100,	136.541000,	45),
(23,	'A1-Ring',	'Spielburg',	'Austria',	47.219700,	14.764700,	678),
(24,	'Yas Marina Circuit',	'Abu Dhabi',	'UAE',	24.467200,	54.603100,	3),
(25,	'Autódromo Juan y Oscar Gálvez',	'Buenos Aires',	'Argentina',	-34.694300,	-58.459300,	8),
(26,	'Circuito de Jerez',	'Jerez de la Frontera',	'Spain',	36.708300,	-6.034170,	37),
(27,	'Autódromo do Estoril',	'Estoril',	'Portugal',	38.750600,	-9.394170,	130),
(28,	'Okayama International Circuit',	'Okayama',	'Japan',	34.915000,	134.221000,	266),
(29,	'Adelaide Street Circuit',	'Adelaide',	'Australia',	-34.927200,	138.617000,	58),
(30,	'Kyalami',	'Midrand',	'South Africa',	-25.989400,	28.076700,	1460),
(31,	'Donington Park',	'Castle Donington',	'UK',	52.830600,	-1.375280,	88),
(32,	'Autódromo Hermanos Rodríguez',	'Mexico City',	'Mexico',	19.404200,	-99.090700,	2227),
(33,	'Phoenix street circuit',	'Phoenix',	'USA',	33.447900,	-112.075000,	345),
(34,	'Circuit Paul Ricard',	'Le Castellet',	'France',	43.250600,	5.791670,	432),
(35,	'Korean International Circuit',	'Yeongam County',	'Korea',	34.733300,	126.417000,	0),
(36,	'Autódromo Internacional Nelson Piquet',	'Rio de Janeiro',	'Brazil',	-22.975600,	-43.395000,	1126),
(37,	'Detroit Street Circuit',	'Detroit',	'USA',	42.329800,	-83.040100,	177),
(38,	'Brands Hatch',	'Kent',	'UK',	51.356900,	0.263056,	145),
(39,	'Circuit Park Zandvoort',	'Zandvoort',	'Netherlands',	52.388800,	4.540920,	6),
(40,	'Zolder',	'Heusden-Zolder',	'Belgium',	50.989400,	5.256940,	36),
(41,	'Dijon-Prenois',	'Dijon',	'France',	47.362500,	4.899130,	484),
(42,	'Fair Park',	'Dallas',	'USA',	32.777400,	-96.758700,	139),
(43,	'Long Beach',	'California',	'USA',	33.765100,	-118.189000,	12),
(44,	'Las Vegas Street Circuit',	'Nevada',	'USA',	36.116200,	-115.174000,	639),
(45,	'Jarama',	'Madrid',	'Spain',	40.617100,	-3.585580,	609),
(46,	'Watkins Glen',	'New York State',	'USA',	42.336900,	-76.927200,	485),
(47,	'Scandinavian Raceway',	'Anderstorp',	'Sweden',	57.265300,	13.604200,	153),
(48,	'Mosport International Raceway',	'Ontario',	'Canada',	44.048100,	-78.675600,	332),
(49,	'Montjuïc',	'Barcelona',	'Spain',	41.366400,	2.151670,	79),
(50,	'Nivelles-Baulers',	'Brussels',	'Belgium',	50.621100,	4.326940,	139),
(51,	'Charade Circuit',	'Clermont-Ferrand',	'France',	45.747200,	3.038890,	790),
(52,	'Circuit Mont-Tremblant',	'Quebec',	'Canada',	46.187700,	-74.609900,	214),
(53,	'Rouen-Les-Essarts',	'Rouen',	'France',	49.330600,	1.004580,	81),
(54,	'Le Mans',	'Le Mans',	'France',	47.950000,	0.224231,	67),
(55,	'Reims-Gueux',	'Reims',	'France',	49.254200,	3.930830,	88),
(56,	'Prince George Circuit',	'Eastern Cape Province',	'South Africa',	-33.048600,	27.873600,	15),
(57,	'Zeltweg',	'Styria',	'Austria',	47.203900,	14.747800,	676),
(58,	'Aintree',	'Liverpool',	'UK',	53.476900,	-2.940560,	20),
(59,	'Circuito da Boavista',	'Oporto',	'Portugal',	41.170500,	-8.673250,	28),
(60,	'Riverside International Raceway',	'California',	'USA',	33.937000,	-117.273000,	470),
(61,	'AVUS',	'Berlin',	'Germany',	52.480600,	13.251400,	53),
(62,	'Monsanto Park Circuit',	'Lisbon',	'Portugal',	38.719700,	-9.203060,	158),
(63,	'Sebring International Raceway',	'Florida',	'USA',	27.454700,	-81.348300,	18),
(64,	'Ain Diab',	'Casablanca',	'Morocco',	33.578600,	-7.687500,	19),
(65,	'Pescara Circuit',	'Pescara',	'Italy',	42.475000,	14.150800,	129),
(66,	'Circuit Bremgarten',	'Bern',	'Switzerland',	46.958900,	7.401940,	551),
(67,	'Circuit de Pedralbes',	'Barcelona',	'Spain',	41.390300,	2.116670,	85),
(68,	'Buddh International Circuit',	'Uttar Pradesh',	'India',	28.348700,	77.533100,	194),
(69,	'Circuit of the Americas',	'Austin',	'USA',	30.132800,	-97.641100,	161),
(70,	'Red Bull Ring',	'Spielburg',	'Austria',	47.219700,	14.764700,	678),
(71,	'Sochi Autodrom',	'Sochi',	'Russia',	43.405700,	39.957800,	2),
(72,	'Port Imperial Street Circuit',	'New Jersey',	'USA',	40.776900,	-74.011100,	4),
(73,	'Baku City Circuit',	'Baku',	'Azerbaijan',	40.372500,	49.853300,	-7),
(74,	'Hanoi Street Circuit',	'Hanoi',	'Vietnam',	21.016600,	105.766000,	9),
(75,	'Autódromo Internacional do Algarve',	'Portimão',	'Portugal',	37.227000,	-8.626700,	108),
(76,	'Autodromo Internazionale del Mugello',	'Mugello',	'Italy',	43.997500,	11.371900,	255),
(77,	'Jeddah Street Circuit',	'Jeddah',	'Saudi Arabia',	21.543300,	39.172800,	15);
...
CREATE TABLE `races` (
  ...
  `gpId` int NOT NULL,
  PRIMARY KEY (`raceId`),
  KEY `races_circuitId_fkey` (`circuitId`),
  KEY `races_gpId_fkey` (`gpId`),
  KEY `races_year_fkey` (`year`),
  CONSTRAINT `races_circuitId_fkey` FOREIGN KEY (`circuitId`) REFERENCES `circuits` (`circuitId`),
  CONSTRAINT `races_gpId_fkey` FOREIGN KEY (`gpId`) REFERENCES `gps` (`gpId`),
  CONSTRAINT `races_year_fkey` FOREIGN KEY (`year`) REFERENCES `seasons` (`year`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3;
...
CREATE TABLE `results` (
  ...
  KEY `results_constructorId_fkey` (`constructorId`),
  KEY `results_driverId_fkey` (`driverId`),
  KEY `results_raceId_fkey` (`raceId`),
  KEY `results_statusId_fkey` (`statusId`),
  CONSTRAINT `results_constructorId_fkey` FOREIGN KEY (`constructorId`) REFERENCES `constructors` (`constructorId`),
  CONSTRAINT `results_driverId_fkey` FOREIGN KEY (`driverId`) REFERENCES `drivers` (`driverId`),
  CONSTRAINT `results_raceId_fkey` FOREIGN KEY (`raceId`) REFERENCES `races` (`raceId`),
  CONSTRAINT `results_statusId_fkey` FOREIGN KEY (`statusId`) REFERENCES `status` (`statusId`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3;
