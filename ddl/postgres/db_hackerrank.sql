...
\connect db_hackerrank;

DROP TABLE IF EXISTS "BST";
CREATE TABLE "public"."BST" (
    "N" integer NOT NULL,
    "P" integer
)
WITH (oids = false);
...
CREATE TABLE "public"."COUNTRY" (
    ...
    "INDEPYEAR" character varying(5) NOT NULL,
    "POPULATION" integer NOT NULL,
    "LIFEEXPECTANCY" character varying(4) NOT NULL,
    "GNP" integer NOT NULL,
    "GNPOLD" character varying(9) NOT NULL,
    "LOCALNAME" character varying(44) NOT NULL,
    "GOVERNMENTFORM" character varying(44) NOT NULL,
    "HEADOFSTATE" character varying(32) NOT NULL,
    "CAPITAL" character varying(4) NOT NULL,
